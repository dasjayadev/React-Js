...
import { initialValue, timeReducer } from './reducer/timeReducer';
...
function Timers() {
  ...
  return (
    <>
        <h1>Timers</h1>
        <div className="clock" style={{backgroundColor:"black",color:"yellow",display:"inline"}}>
        ...
        <div className="inputs">
            ...
            <input type="number" name="hours" id='hours' placeholder='Enter hours' /><br/>
            <label htmlFor="minutes">Minutes</label>
            <input type="number" name="minutes" id='minutes' placeholder='Enter minutes' /><br/>
